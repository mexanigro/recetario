...
export const TEXTOS = {
  he: {
    ...
    delete_btn: "מחיקת המתכון",
    delete_word: "מחיקה",
    delete_prompt: "מחיקה היא סופית — אין דרך לשחזר. כדי לאשר, כתבו כאן את המילה:",
    delete_confirm: "למחוק לצמיתות",
    delete_cancel: "ביטול",
    delete_error: "לא הצלחנו למחוק. נסו שוב.",
  ...
  en: {
    ...
    delete_word: "DELETE",
    delete_prompt: "Deleting is final — there is no way back. To confirm, type this word:",
    delete_confirm: "Delete permanently",
    delete_cancel: "Cancel",
    delete_error: "We couldn't delete it. Try again.",
